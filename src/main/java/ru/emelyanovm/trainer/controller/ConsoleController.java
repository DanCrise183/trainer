package ru.emelyanovm.trainer.controller;

import org.springframework.stereotype.Controller;
import ru.emelyanovm.trainer.domain.model.OpenQuestionCard;
import ru.emelyanovm.trainer.domain.service.QuestionService;
...
public class ConsoleController {
    ...
    public void interactWithUser() {
        ...
        while (true) {
            System.out.println("1 - Показать все вопросы, 2 - Добавить, 3 - Найти, 4 - Выйти");
