package ru.dancrise.console.controller;
...
public class ConsoleController {
  ...
  private void removeQuestion() {
    ...
    if (question.isPresent()) {
      System.out.println("Введите [Y], если точно хотите удалить вопрос: " + question.get().getTitle());
  ...
  private void findQuestion() {
    ...
    Optional<OpenQuestionCard> question = service.getByID(Long.valueOf(id));
    if (question.isPresent()) {
